        ...
        <div className="mt-10 grid gap-8 md:grid-cols-3">
          {paket.map((item, index) => (
            <FadeUp key={item.id} delay={index * 120}>
              <article className="overflow-hidden rounded-lg border border-gray-400 bg-white shadow-sm h-full">
                ...
                <div className="p-4">
                  ...
                  <p className="mt-4 text-center text-sm font-black text-black">
                    ...
                    <span className="text-xs text-[#68247B]">/ bulan</span>
                  </p>

                  <div className="mt-4 grid gap-2">
                    <button className="h-11 rounded bg-[#68247B] text-sm font-black text-white transition-all duration-200 hover:bg-white hover:text-[#68247B] hover:border hover:border-[#68247B]">Berlangganan Sekarang</button>
